...
################################################################
# This is a generated script based on design: cpu_nexys4
#
...
proc create_root_design { parentCell } {
  ...
  set uart1_recv [ create_bd_port -dir I uart1_recv ]
  set uart1_send [ create_bd_port -dir O uart1_send ]
  set uart2_recv [ create_bd_port -dir I uart2_recv ]
  set uart2_send [ create_bd_port -dir O uart2_send ]
  ...
  connect_bd_net -net MOSI [get_bd_ports MOSI] [get_bd_pins axi_quad_spi_0/io0_o]
  connect_bd_net -net SCLK0 [get_bd_ports SCLK0] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net SCLK1 [get_bd_ports SCLK1] [get_bd_pins axi_quad_spi_1/sck_o]
  connect_bd_net -net SS0 [get_bd_ports SS0] [get_bd_pins axi_quad_spi_0/ss_o]
  ...
  connect_bd_net -net axi_gpio_2_ip2intc_irpt [get_bd_pins axi_gpio_2/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In1]
